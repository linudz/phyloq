#!/usr/bin/env bash
#SBATCH --job-name=mammal_pss_production
#SBATCH --output=logs/mammal_pss_production_driver_%j.out
#SBATCH --error=logs/mammal_pss_production_driver_%j.err
#SBATCH --ntasks=1
...
PARAMS_FILE="${1:?Pass the production params file}"
shift
