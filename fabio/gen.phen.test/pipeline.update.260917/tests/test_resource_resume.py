...
class ResourceResume(unittest.TestCase):
    ...
    def test_bridge_matches_reviewed_continuation_code(self):
        ...
        self.assertEqual(resume_identity(self.old, dict(self.new, code_fingerprint=actual), self.bridge), self.old)
